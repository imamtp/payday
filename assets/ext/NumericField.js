...
Ext.define('Ext.ux.form.NumericField', 
{
	...
	constructor: function(config){
        ...
        if (this.useThousandSeparator && this.decimalSeparator == ',') 
            this.thousandSeparator = '.';
        else 
            if (this.allowDecimals && this.thousandSeparator == '.') 
    ...
    hasFormat: function(){
        return this.decimalSeparator != '.' || (this.useThousandSeparator == true && this.getRawValue() != null && this.getRawValue().indexOf(this.thousandSeparator) != - 1 )|| !Ext.isEmpty(this.currencySymbol) || this.alwaysDisplayDecimals;
    },
    /**
