Ext.define('GridJamKerja5ListModel', {
...
var storeGridJamKerja5List = Ext.create('Ext.data.Store', {
    pageSize: 100,
    model: 'GridJamKerja5ListModel',
    //remoteSort: true,
    // autoload:true,
    proxy: {
        type: 'ajax',
...
Ext.define('MY.searchJamKerja5List', {
    extend: 'Ext.ux.form.SearchField',
    alias: 'widget.searchJamKerja5List',
    store: storeGridJamKerja5List,
    width: 180
});

var smGridJamKerja5List = Ext.create('Ext.selection.CheckboxModel', {
    allowDeselect: true,
    mode: 'SINGLE',
    listeners: {
...
Ext.define('GridJamKerja5List', {
    itemId: 'GridJamKerja5List',
    id: 'GridJamKerja5List',
    extend: 'Ext.grid.Panel',
    alias: 'widget.GridJamKerja5List',
    store: storeGridJamKerja5List,
    loadMask: true,
    columns: [
    {
            ...
            handler: function(grid, rowIndex, colIndex, actionItem, event, selectedRecord, row) {
                    Ext.getCmp('idjamkerjaharian5_fJadwalKerja').setValue(selectedRecord.get('idjamkerjaharian'));
                    Ext.getCmp('namajamkerja5_fJadwalKerja').setValue(selectedRecord.get('namajamkerja'));

                    Ext.getCmp('wGridJamKerja5ListPopup').hide();
            }
        },
    ...
    , dockedItems: [
        {
            ...
            store: storeGridJamKerja5List, // same store GridPanel is using
            dock: 'bottom',
            displayInfo: true
                    // pageSize:20
        }
...
var wGridJamKerja5ListPopup = Ext.create('widget.window', {
    id: 'wGridJamKerja5ListPopup',
