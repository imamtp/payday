Ext.define('GridJamKerja3ListModel', {
...
var storeGridJamKerja3List = Ext.create('Ext.data.Store', {
    pageSize: 100,
    model: 'GridJamKerja3ListModel',
    //remoteSort: true,
    // autoload:true,
    proxy: {
        type: 'ajax',
...
Ext.define('MY.searchJamKerja3List', {
    extend: 'Ext.ux.form.SearchField',
    alias: 'widget.searchJamKerja3List',
    store: storeGridJamKerja3List,
    width: 180
});

var smGridJamKerja3List = Ext.create('Ext.selection.CheckboxModel', {
    allowDeselect: true,
    mode: 'SINGLE',
    listeners: {
...
Ext.define('GridJamKerja3List', {
    itemId: 'GridJamKerja3List',
    id: 'GridJamKerja3List',
    extend: 'Ext.grid.Panel',
    alias: 'widget.GridJamKerja3List',
    store: storeGridJamKerja3List,
    loadMask: true,
    columns: [
    {
            ...
            handler: function(grid, rowIndex, colIndex, actionItem, event, selectedRecord, row) {
                    Ext.getCmp('idjamkerjaharian3_fJadwalKerja').setValue(selectedRecord.get('idjamkerjaharian'));
                    Ext.getCmp('namajamkerja3_fJadwalKerja').setValue(selectedRecord.get('namajamkerja'));

                    Ext.getCmp('wGridJamKerja3ListPopup').hide();
            }
        },
    ...
    , dockedItems: [
        {
            ...
            xtype: 'pagingtoolbar',
            store: storeGridJamKerja3List, // same store GridPanel is using
            dock: 'bottom',
            displayInfo: true
                    // pageSize:20
        }
...
var wGridJamKerja3ListPopup = Ext.create('widget.window', {
    id: 'wGridJamKerja3ListPopup',
