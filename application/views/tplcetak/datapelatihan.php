...
<center>
    ...
    <tr style="background-color: #dceef7; color: #000; font-size: 12px;">
         ...
         <td><b>Jenis Pelatihan</td>
         <td><b>Tgl Pelatihan</td>
         <td><b>No Sertifikat</td>
         <td><b>Jenis Sertifikat</td>
    </tr>
    ...
    foreach ($data->result() as $r) {
		...
		if($r->display!=null)
            ...
            <tr style="font-size: 12px;">
                 ...
                 <td><?=$r->tglmasuk?></td>
                 <td><?=$r->tglberakhir?></td>
                 <td><?=$r->namapelatihan?></td>
                 <td><?=$r->jenispelatihan?></td>
                 <td><?=$r->tglpelatihan?></td>
                 <td><?=$r->nosertifikat?></td>
                 <td><?=$r->jenissertifikat?></td>
            </tr>
