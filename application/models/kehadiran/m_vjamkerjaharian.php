...
class m_vjamkerjaharian extends CI_Model {

    function tableName() {
        return 'v_jamkerjaharian';
    }
    ...
    function searchField() {
        $field = "kodejamkerja,namajamkerja,jammasuk,jamkeluar,toleransihadir_menit,mulaiistirahat,akhiristirahat,toleransiistirahat_menit";
        return explode(",", $field);
    }

    function selectField() {
        return "idjamkerjaharian,idcompany,kodejamkerja,namajamkerja,jammasuk,jamkeluar,toleransihadir_menit,mulaiistirahat,akhiristirahat,toleransiistirahat_menit";
    }
