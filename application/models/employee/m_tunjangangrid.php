...
class m_tunjangangrid extends CI_Model {
    ...
    function updateField() { 
        $data = array(
            ...
            'jumlah'=>$this->input->post('jumlah')!='' ? cleardot2($this->input->post('jumlah')) : null,
            'persen'=>$this->input->post('persen')!='' ? str_replace(',', '.', $this->input->post('persen')) : null,
