...
class m_pilihemployeegrid extends CI_Model {
    ...
    function whereQuery() {
        ...
        $m = $periodeArr[1];
        $y = $periodeArr[0];
        return " a.idunit = $idunit and idemployee NOT IN (select idemployee from payrolltmp) and idemployee not in (select idemployee from payrollproceed where month='$m' and year=$y)";
    }
