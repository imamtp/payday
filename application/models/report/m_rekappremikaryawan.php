...
class m_rekappremikaryawan extends CI_Model {
    ...
    function title()
    {
        return "Rekap Premi Yang Ditanggung Karyawan";
    }
    ...
    function searchField() {
        $field = "a.percente,SUM(a.amounte) as total,b.namapremi,b.deskripsi";
        return explode(",", $field);
    }

    function selectField() {
        return "a.percente,sum(a.amounte) as total,b.namapremi,b.deskripsi,d.totalpegawai";
    }
...
// print_r($arrSd);
        ...
        return " WHERE c.idunit=$idunit and (a.month='".$arrSd[1]."' and a.year=".$arrSd[0].")";
    }
    ...
    function groupBy() {
        return " GROUP BY a.percente,b.namapremi,b.deskripsi,d.totalpegawai";
    }
