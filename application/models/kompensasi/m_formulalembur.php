    ...
    function updateField() { 
       ...
       if(!is_array($komponenupahpemerintah))
       {
        ...
        $data = array(
            ...
            "faktorpembagiharianlibur"  => $this->input->post('faktorpembagiharianlibur') == NULL ? NULL : $this->input->post('faktorpembagiharianlibur'),
            "angkatetapharianlibur"  => $this->input->post('angkatetapharianlibur') == NULL ? NULL : $this->input->post('angkatetapharianlibur'),
            "statusharianraya"  => $this->input->post('statusharianraya') == NULL ? NULL : $this->input->post('statusharianraya'),
            "jenisnilaiharianraya"  => $this->input->post('jenisnilaiharianraya') == NULL ? NULL : $this->input->post('jenisnilaiharianraya'),
            "komponenupahharianraya"  => $komponenupahharianrayaVal,
            "faktorpembagiharianraya"  => $this->input->post('faktorpembagiharianraya') == NULL ? NULL : $this->input->post('faktorpembagiharianraya'),
            "angkatetapharianraya"  => $this->input->post('angkatetapharianraya') == NULL ? NULL : $this->input->post('angkatetapharianraya'),
            "statusjamkerja"  => $this->input->post('statusjamkerja') == NULL ? NULL : $this->input->post('statusjamkerja'),
            "jumlahjamkerja"  => $this->input->post('jumlahjamkerja') == NULL ? NULL : $this->input->post('jumlahjamkerja'),
            "jenisnilaijamkerja"  => $this->input->post('jenisnilaijamkerja') == NULL ? NULL : $this->input->post('jenisnilaijamkerja'),
            "komponenupahjamkerja"  => $komponenupahjamkerjaVal,
            "faktorpembagijamkerja"  => $this->input->post('faktorpembagijamkerja') == NULL ? NULL : $this->input->post('faktorpembagijamkerja'),
            "angkatetapjamkerja"  => $this->input->post('angkatetapjamkerja') == NULL ? NULL : $this->input->post('angkatetapjamkerja'),
            "statusjamlibur"  => $this->input->post('statusjamlibur') == NULL ? NULL : $this->input->post('statusjamlibur'),
            "jumlahjamlibur"  => $this->input->post('jumlahjamlibur') == NULL ? NULL : $this->input->post('jumlahjamlibur'),
            "jenisnilaijamlibur"  => $this->input->post('jenisnilaijamlibur') == NULL ? NULL : $this->input->post('jenisnilaijamlibur'),
            "komponenupahjamlibur"  => $komponenupahjamliburVal,
            "faktorpembagijamlibur"  => $this->input->post('faktorpembagijamlibur') == NULL ? NULL : $this->input->post('faktorpembagijamlibur'),
            "angkatetapjamlibur"  => $this->input->post('angkatetapjamlibur') == NULL ? NULL : $this->input->post('angkatetapjamlibur'),
            "statusjamraya"  => $this->input->post('statusjamraya') == NULL ? NULL : $this->input->post('statusjamraya'),
            "jumlahjamraya"  => $this->input->post('jumlahjamraya') == NULL ? NULL : $this->input->post('jumlahjamraya'),
            "jenisnilaijamraya"  => $this->input->post('jenisnilaijamraya') == NULL ? NULL : $this->input->post('jenisnilaijamraya'),
            "komponenupahjamraya"  => $komponenupahjamrayaVal,
            "faktorpembagijamraya"  => $this->input->post('faktorpembagijamraya') == NULL ? NULL : $this->input->post('faktorpembagijamraya'),
            "angkatetapjamraya"  => $this->input->post('angkatetapjamraya') == NULL ? NULL : $this->input->post('angkatetapjamraya'),
            "jenisformula" => $this->input->post('jenisformula') == NULL ? NULL : $this->input->post('jenisformula'),
            "kenapajak" => $this->input->post('kenapajak') == NULL ? NULL : $this->input->post('kenapajak'),
            "fungsipajak" => $this->input->post('fungsipajak') == NULL ? NULL : $this->input->post('fungsipajak'),
            "hitungpajak" => $this->input->post('hitungpajak') == NULL ? NULL : $this->input->post('hitungpajak'),
            "persentasehariankerja" => $this->input->post('persentasehariankerja') == NULL ? NULL : $this->input->post('persentasehariankerja'),
            "persentaseharianlibur" => $this->input->post('persentaseharianlibur') == NULL ? NULL : $this->input->post('persentaseharianlibur'),
            "persentaseharianraya" => $this->input->post('persentaseharianraya') == NULL ? NULL : $this->input->post('persentaseharianraya'),
            "persentasejamkerja" => $this->input->post('persentasejamkerja') == NULL ? NULL : $this->input->post('persentasejamkerja'),
            "persentasejamlibur" => $this->input->post('persentasejamlibur') == NULL ? NULL : $this->input->post('persentasejamlibur'),
            "persentasejamraya" => $this->input->post('persentasejamraya') == NULL ? NULL : $this->input->post('persentasejamraya'),
