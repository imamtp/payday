...
class m_configupahttbulan extends CI_Model {
    ...
    function whereQuery() {
         return "a.jeniskomponen='Upah Tidak Tetap' AND a.jangkawaktu='Bulanan' AND a.display is null ". $this->m_data->whereCompany()."";
    }
