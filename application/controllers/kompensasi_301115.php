...
//                 exit;
            ...
            $biayajabatan = $data[$i]['penerimaanbruto']*0.05;
                        ...
                        if($data[$i]['masapajaksetahun']<12)
                        {
                            ...
                            {
                                $obj->pphterminasi = $obj->pphsettahun/$data[$i]['masapajaksetahun'];
                            } else {
                                $obj->pphterminasi = 0;
                            }
...
// echo $this->db->last_query();
    ...
    function tunjanganpajak($idpelamar,$startdate,$enddate,$tglgajipertama,$hitungpajak,$punyanpwp,$tglmasuk,$nilaiptkp,$benefitCmp,$benefitEmp,$penghasilanbrutoParams,$totalUT,$totalUTT,$biayajabatanstatus,$totallembur,$masapajaksetahun,$utPengurangPajak,$utTPengurangPajak,$upahlemburKurangPajak,$benefitPengurangPajak,$masapajak)
    {
        // $startdate = backdate2_reverse($startdate);
        $startdateArr = explode('-', $startdate);
        // $enddate = backdate2_reverse($enddate);
            ...
            $penghasilanbrutoOld = $penghasilanbrutoParams;
                    for($j=0;$j<$masapajaksetahun;$tunjanganpajak++) {
                       // echo $tunjanganpajak.' ';
                        ...
                        {
                            $penghasilanbruto = $penghasilanbrutoParams;
                        }
                        ...
                        $penghasilannet = $penghasilanbruto-($benefitEmp+$data[$i]['biayajabatan'])-($utPengurangPajak+$utTPengurangPajak+$upahlemburKurangPajak+$benefitPengurangPajak);
                                                
                        $totalpendapatan =  $data[$i]['totalUT']+$data[$i]['totalUTT']+$totallembur+$benefitCmp+$tunjanganpajak;
