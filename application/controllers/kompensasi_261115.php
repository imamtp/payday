...
class kompensasi extends MY_Controller {
    ...
    function penggajian($idcompany=null,$startdate=null,$enddate=null)
    {
        ...
        $sqlpeg = "select a.idpelamar,idptkp,namalengkap,aaa.tglmasuk,aa.tglberakhir,punyanpwp,biayajabatan,jenispotonganpph,bb.idpergerakan,
                    b.nik,c.companycode,e.kodeorg,f.namajabatan
                    from pelamar a
                    ...
                    join strukturjabatan d ON aa.idstrukturjabatan = d.idstrukturjabatan
                    join organisasi e ON d.idorganisasi = e.idorganisasi
                    join jabatan f ON d.idjabatan = f.idjabatan
                    JOIN
                    (
                    ...
                    where a.idcompany=$idcompany and a.idptkp is not null 
